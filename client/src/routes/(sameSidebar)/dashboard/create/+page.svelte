<script>
	...
	const steps = [
		...
		{ id: 'perks', label: 'Rewards', description: 'Tiers & Items' },
...
<div class="wizard-layout">
	...
	<header class="wizard-header">
		<div class="header-content container">
			...
			<button onclick={handleSaveExit} class="btn-exit" aria-label="Save and Exit">
				<div class="logo-icon">
					{@html icons.logo}
				</div>
				...
				<div class="desktop-stepper">
					...
					{#each steps as step, index}
						...
						<div class="step-node">
							...
							<div class="step-label {isActive ? 'visible' : ''}">
								{step.label}
							</div>
						</div>
					{/each}
			...
			<!-- Right: Close Button -->
			<button onclick={handleSaveExit} class="btn-close" aria-label="Close Wizard">
				{@html icons.x}
			</button>
		</div>
	</header>
